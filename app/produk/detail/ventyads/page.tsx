...
export const metadata = {
  title: "Ventyads| Ventyfour",
  description: "Platform manajemen iklan digital yang canggih.",
};

export default function VentyadsPage() {
  const product = products.find((p) => p.slug === "ventyads");
          ...
          <div className="flex flex-col space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-neutral-700 dark:text-neutral-300 space-y-1">
                <li>Integrasi Meta & Google Ads</li>
                <li>Dashboard performa realtime</li>
                <li>Fitur A/B testing iklan</li>
              </ul>
            </div>
